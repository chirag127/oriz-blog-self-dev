...
export const SITE_CONFIG: BlogConfig = {
  title: 'practicelog',
  description: 'A working log of habits, focus, and follow-through — the practices that hold when motivation is gone. By Chirag Singhal.',
  url: 'https://self-dev-blog.oriz.in',
  defaultLocale: 'en',
  author: {
    name: 'Chirag Singhal',
  ...
  giscus: {
    repo: env('PUBLIC_GISCUS_REPO', 'chirag127/oriz-blog-self-dev') as `${string}/${string}`,
