# Self-Dev — `oriz-blog-self-dev`

> Systems over willpower — habits, focus, and the mechanics of getting better.

[![License: MIT](https://img.shields.io/badge/License-MIT-e4572e.svg)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/chirag127/oriz-blog-self-dev?style=flat)](https://github.com/chirag127/oriz-blog-self-dev/stargazers)
[![Last commit](https://img.shields.io/github/last-commit/chirag127/oriz-blog-self-dev)](https://github.com/chirag127/oriz-blog-self-dev/commits/main)
[![Deploy](https://github.com/chirag127/oriz-blog-self-dev/actions/workflows/deploy.yml/badge.svg)](https://github.com/chirag127/oriz-blog-self-dev/actions/workflows/deploy.yml)
[![Built with Astro](https://img.shields.io/badge/built%20with-Astro-ff5d01.svg)](https://astro.build)

**Self-Dev** is a static, content-first blog built with Astro and deployed to Cloudflare Pages.
A self-development blog about habits, focus, and productivity systems — built on mechanics that hold up, not motivational filler.

- **Live site:** https://self-dev-blog.oriz.in · **Repo:** https://github.com/chirag127/oriz-blog-self-dev
- **GitHub Pages landing:** https://chirag127.github.io/oriz-blog-self-dev/ — the canonical, always-current site is **https://self-dev-blog.oriz.in** (Cloudflare Pages); GitHub Pages is not the deploy target for this repo.

> ⭐ **If this is useful, please [star the repo](https://github.com/chirag127/oriz-blog-self-dev/stargazers)** — it helps others find it.
...
flowchart LR
    ...
    D --> E["Cloudflare Pages<br/>self-dev-blog.oriz.in"]
...
oriz-blog-self-dev/
├── src/
│   ├── content/blog/       # the self-development essays (MDX/Markdown)
